...
class Content extends Component {
  ...
  displayImg = () => {
    ...
    let imgComponent = (<div><span className="thumbnail-area"><img className="thumbnail" src={imgSrc} /></span><strong className="video-title">{this.props.content.name}</strong><em className="channel-title">{this.props.content.channel}</em></div>);
