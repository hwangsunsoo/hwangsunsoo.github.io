		...
		return (
			<div className="navbar">
				<header className="header">
					<h1 className="site-title"><Link className="site-title-link" to="/pomnyunTube/home">Pomnyun Tube</Link></h1>
				...
				<nav className="navbar-area" aria-expanded={this.state.navIsActive}>
					...
					<ul className="navbar-list">
						<li className="navbar-item"><Link className="navbar-link" to="/pomnyunTube/home">사용방법 안내</Link></li>
						<li className="navbar-item"><Link className="navbar-link" to="/pomnyunTube/search">키워드 검색</Link></li>
						<li className="navbar-item"><Link className="navbar-link" to="/pomnyunTube/category/test">카테고리 테스트</Link></li>
					</ul>
				</nav>
			</div>
		)
